...
- One person to serve as the **Narrator** — the person running the world and its characters
- One to four additional players, each running one of the pregenerated characters
- Standard polyhedral dice: d4, d6, d8, d10, d12
- Pencils and paper, or any note-taking method

## How Long Does It Take?

*The Weight of Silence* is designed for a single session of approximately three to four hours.
