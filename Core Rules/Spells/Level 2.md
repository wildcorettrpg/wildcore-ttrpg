...
Any creature within the darkness that relies on sight to perceive is treated as Blinded. Creatures with abilities that allow them to perceive without light are unaffected.
...
The Narrator determines what the echo shows, based on the history of the object or location. The caster cannot direct or query it. They receive what comes.
