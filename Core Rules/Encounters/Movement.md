...
Movement represents a character's ability to reposition during a round. All movement is measured in feet and requires spending AP unless a rule, skill, or ability states otherwise. When a character spends AP on movement, they gain a movement pool. This pool may be used before, between, or after actions during the character's turn.
...
Movement through difficult terrain is halved, rounding up to the nearest 5-foot increment. Difficult terrain includes rubble, deep water, dense foliage, unstable surfaces, or any environment the Narrator designates as obstructive. Abilities may ignore or reduce the effects of difficult terrain.

## Forced Movement

Forced movement is movement imposed by an external effect. It does not cost the target any AP and does not provoke reactions unless a rule or ability states otherwise. Forced movement may move a character into or out of melee range, and may knock a character prone if the effect specifies it. A character cannot use their own movement to resist forced movement unless a skill explicitly allows it.

## Movement and Reactions

Movement may trigger reactions such as opportunity attacks or abilities that activate when a character enters or leaves a zone. A character may take one Reaction per round unless a rule, skill, or lineage grants additional Reactions.
...
Some abilities grant special movement modes such as teleportation, shadow-step, supernatural leaps, flight, gliding, phasing, or intangibility. Unless otherwise stated, special movement does not provoke reactions, ignores difficult terrain, and teleportation cannot be intercepted. Each special movement ability defines its own limitations and AP costs.
