...
Both sides roll their dice pool: every character rolls a minimum of 1d10 regardless of skills, and skills that explicitly grant dice add to this base. Flat bonuses from applicable skills are added after rolling, and each side then adds their relevant Attribute as a flat bonus. The side with the highest total wins the contest. If both sides arrive at the same total, the result is a stalemate.
