...
At **Healing V**, the healer may apply items from a Healer's Bag (**1 AP** per treatment, one item consumed). Alternatively, at **Healing VII**, they may instead use a Master Healer's Satchel. Item effects are defined in [Gear](../Equipment/Gear.md) §Healer's Supplies.

**Heroic Measures** (Healing VI+) is a special intervention for injured characters near death. On a successful Opposition Check against a Narrator-assigned difficulty based on injury severity plus 4, the patient is Stabilized, regains consciousness, and recovers **1d6 + Willpower** Health (Healer's Bag) or **2d6 + Willpower** (Master Healer's Satchel). See [Healing](../Skills/Universal/Survival/Healing%20Skill.md) §Notes.
