...
The following items from this table are provided free to every character at creation — they do not cost starting gold and are pre-populated on the character sheet:
...
This list is a first draft, in keeping with the draft status of [Weapons](Weapons.md) and [Armor](Armor.md)'s item tables. It covers common adventuring gear; expand it as play surfaces needs the Narrator can't price from this baseline.
